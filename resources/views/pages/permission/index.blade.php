...
@section('content')
            ...
            <div
                ...
                <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                    ...
                    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                        <div class="grow">
                            <h5 class="text-16">Permissions List View</h5>
                        </div>
                        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                            <li
                                class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                                <a href="#!" class="text-slate-400 dark:text-zink-200">Permissions</a>
                            </li>
                            ...
                            <div class="card" id="usersTable">
                                <div class="card-body">
                                    <div class="flex items-center">
                                        <h6 class="text-15 grow">Users Permissions</h6>
                                        <div class="shrink-0">
                                            <button data-modal-target="addPermissionModal" type="button"
                                                class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                                                    data-lucide="plus" class="inline-block size-4"></i> <span
                                                    class="align-middle">Add Permission</span></button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody class="list">
                                                @foreach ($permissions as $permission)
                                                    <tr
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                            <a href="#!"
                                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id">{{ $permission->id }}</a>
                                                        </td>
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 flex space-x-2">
                                                            ...
                                                            <a data-modal-target="editPermissionModal{{ $permission->id }}"
                                                            ...
                                                            <a data-modal-target="deleteModal{{ $permission->id }}"
                                                    ...
                                                    <!-- Edit User Modal -->
                                                    <div id="editPermissionModal{{ $permission->id }}" modal-center=""
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <button
                                                                    data-modal-close="editPermissionModal{{$permission->id }}"
                                                    ...
                                                    {{-- delete user --}}
                                                    <div id="deleteModal{{$permission->id }}" modal-center=""
                                                        class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    ...
                                                                    <div class="flex justify-center gap-2 mt-6">
                                                                        <button type="button"
                                                                            data-modal-close="deleteModal{{$permission->id }}"
                                        ...
                                        <div class="noresult" style="display: none">
                                            <div class="py-6 text-center">
                                                ...
                                                <p class="mb-0 text-slate-500 dark:text-zink-200">We've searched more than
                                                    199+ Permissions We did not find any users for you search.</p>
                                            </div>
                                        </div>
                                    </div>
    ...
    {{-- add user --}}
    <div id="addPermissionModal" modal-center=""
        class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
