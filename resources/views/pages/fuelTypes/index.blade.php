                ...
                <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                    ...
                    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                        ...
                        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                            <li
                                ...
                                <a href="#!" class="text-slate-400 dark:text-zink-200">Fuel Types</a>
                            </li>
                    ...
                    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <div class="card" id="modelsTable">
                                <div class="card-body">
                                    <div class="flex items-center">
                                        <h6 class="text-15 grow">Fuel Types List</h6>
                                        <div class="shrink-0">
                                            <a data-modal-target='addModal'
                                                class="text-white cursor-pointer btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                                                    ...
                                                    class="align-middle">Add</span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="!py-3.5 card-body border-y border-dashed border-slate-200 dark:border-zink-500">
                                    <form action="{{route('fuel-types.index')}}">
                                        @csrf
                                        @method('GET')
                                            ...
                                            <thead class="text-left">
                                                <tr
                                                    ...
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="user-id">#</th>
                                                    {{-- <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                            data-sort="name">Logo</th> --}}
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                            ...
                                            <tbody class="list">
                                                @foreach ($fuelTypes as $fuelType)
                                                    <tr
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                            <a href="{{route('fuel-types.show',$fuelType->id)}}"
                                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id">{{ $fuelType->id }}</a>
                                                        </td>
                                                        {{-- <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 location">
                                                            <img src="{{asset( $fuelType->logo )}}" class=" w-10 h-10 object-cover" alt="logo">
                                                        </td> --}}
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 location">
                                                            {{ $fuelType->name }}</td>
                                                        </td> 
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 flex space-x-2">
                                                            ...
                                                            <a data-modal-target="editModal{{ $fuelType->id }}"
                                                                ...
                                                                <i data-lucide="file-edit"
                                                                    class="inline-block size-4 ltr:mr-1 rtl:ml-1 text-custom-500"></i>
                                                            </a>

                                                            <!-- Delete Button (Red Icon) -->
                                                            <a data-modal-target="deleteModal{{ $fuelType->id }}"
                                                                class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 hover:bg-slate-100 hover:text-red-500 focus:bg-slate-100 focus:text-red-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                                href="#!">
                                                    ...
                                                    <!-- Edit  Modal -->
                                                    <div id="editModal{{ $fuelType->id }}" modal-center=""
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <h5 class="text-16">Edit Make Information</h5>
                                                                <button
                                                                    data-modal-close="editModal{{ $fuelType->id }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{ route('fuel-types.update', $fuelType->id) }}" enctype="multipart/form-data"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="username-field" class="inline-block mb-2 text-base font-medium">Desc</label>
                                                                        <input type="text" name="description" id="username-field"
                                                                            value="{{ $fuelType->description }}"
                                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                                            placeholder="Enter description ">
                                                                    </div>
                                                                    <div class="flex justify-end gap-2 mt-4">
                                                                        <button type="reset" data-modal-close="editModal{{ $fuelType->id }}"
                                                    ...
                                                    {{-- delete user --}}
                                                    <div id="deleteModal{{ $fuelType->id }}" modal-center=""
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    ...
                                                                    <p class="text-slate-500 dark:text-zink-200">Are you
                                                                        ...
                                                                        <strong>{{ $fuelType->first_name }}</strong>?</p>
                                                                    <div class="flex justify-center gap-2 mt-6">
                                                                        <button type="button"
                                                                            data-modal-close="deleteModal{{ $fuelType->id }}"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('fuel-types.destroy', $fuelType->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                        ...
                                        <div class="noresult" style="display: none">
                                            <div class="py-6 text-center">
                                                ...
                                                <p class="mb-0 text-slate-500 dark:text-zink-200">We've searched more than
                                                    199+ fuel-types We did not find any fuel-types for you search.</p>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div id="addModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="{{ route('fuel-types.store') }}" class="mt-1" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <button type="reset" data-modal-close="addModal"
                            class="text-red-500 transition-all duration-200 ease-linear bg-white border-white btn hover:text-red-600 focus:text-red-600 active:text-red-600 dark:bg-zink-500 dark:border-zink-500">Cancel</button>
                        <button type="submit"
                            class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                            Save</button>
