                        ...
                        <div class="grid grid-cols-1 gap-5 lg:grid-cols-12 2xl:grid-cols-12">
                            <div class="lg:col-span-2 2xl:col-span-1">
                                <div class="relative inline-block rounded shadow-md  bg-slate-100 profile-user ">
                                    <img src="{{asset($customer->photo)}}" alt="" class="object-cover border-0 img-thumbnail user-profile-image">
                            ...
                            <div class="lg:col-span-10 2xl:col-span-9">
                                <h5 class="mb-1">{{$customer->first_name . ' '.$customer->middle_name.' '.$customer->last_name}} <i data-lucide="badge-check" class="inline-block size-4 text-sky-500 fill-sky-100 dark:fill-custom-500/20"></i></h5>
                                {{-- <div>
                                    <span class=" text-slate-500 dark:text-zink-200">Account</span>
                                    <h3>{{$customer->account_number}}</h3>
                                </div> --}}
                                <div class="flex gap-3 mb-4">
                                    ...
                                    <p class="text-slate-500 dark:text-zink-200"><i data-lucide="map-pin" class="inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-500"></i> {{$customer->address}}</p>
                                </div>
                                <ul class="flex flex-wrap gap-3 mt-4 text-center divide-x divide-slate-200 dark:divide-zink-500 rtl:divide-x-reverse">
                                    <li class="px-5">
                                        ...
                                        <p class="text-slate-500 dark:text-zink-200">Account Number</p>
                                    </li>
                                    <li class="px-5">
                                    ...
                                    <li class="px-5">
                                        <h5>{{$customer->balance}} ETB</h5>
                                        <p class="text-slate-500 dark:text-zink-200">Current Balance</p>
                                    </li>
                                </ul>
                                                ...
                                                <table class="w-full ltr:text-left rtl:ext-right">
                                                    <tbody>
                                                        <tr class=" bg-slate-100 dark:bg-zink-600">
                                                            ...
                                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200">{{$customer->first_name.' '.$customer->middle_name.' '.$customer->last_name}}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-2 font-semibold ps-0" scope="row">Phone No</th>
                                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200">{{$customer->phone_number}}</td>
                                                        </tr>
                                                        <tr class=" bg-slate-100 dark:bg-zink-600">
                                                        ...
                                                        <tr>
                                                            <th class="py-2 font-semibold ps-0" scope="row">Joined Date</th>
                                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200">{{$customer->join_date}}</td>
                                                        </tr>
                                                        <tr class=" bg-slate-100 dark:bg-zink-600">
                                                            <th class="py-2 font-semibold ps-0" scope="row">Email</th>
                                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200">{{$customer->email}}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-2 font-semibold ps-0" scope="row">Address</th>
                                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200">{{$customer->address}}</td>
                                                        </tr>
                                                        <tr class=" bg-slate-100 dark:bg-zink-600">
                                                            <th class="py-2 font-semibold ps-0" scope="row">Account Type</th>
                                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200">{{$customer->account_type}}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="py-2 font-semibold ps-0" scope="row">Account Number</th>
                                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200">{{$customer->account_number}}</td>
                                                        </tr>
                                                        <tr class=" bg-slate-100 dark:bg-zink-600">
                                                            <th class="py-2 font-semibold ps-0" scope="row">Account Opening Branch</th>
                                                            <td class="py-2 text-right text-slate-500 dark:text-zink-200">{{$customer->branch_name}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                    ...
                                    <div class=" xl:col-span-6 ">
                                        <div class="text-center card ">
                                            <div class="flex flex-col h-full card-body">
                                                <h6 class="mb-4 text-15 text-left">Kebele ID Front</h6>
                                                <img src="{{asset($customer->id_front)}}" alt="" class="w-full h-full mx-auto">
                                            </div>
                                        </div><!--end col-->
                                        <div class="text-center card  ">
                                            <div class="flex flex-col h-full card-body">
                                                <h6 class="mb-4 text-15 text-left">Kebele ID Back</h6>
                                                <img src="{{asset($customer->id_back)}}" alt="" class="w-full h-full mx-auto">
                                            </div>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <table class="w-full whitespace-nowrap">
                                        <thead class="ltr:text-left rtl:text-right">
                                            <tr>
                                                ...
                                                <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">Amount</th>
                                                <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">Status</th>
                                                <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">Type</th>
                                                {{-- <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">Description</th> --}}
                                                <th class="px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500">PDF</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">2 April, 2024</td>
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">$1000</td>
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 text-green-500">Done</td>
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">Deposit</td>
                                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500"><a href="#!" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600"><i class="ri-download-2-line"></i></a></td>
                                            </tr>
...
<!--Add Documents Modal-->
<div id="addDocuments" modal-center="" class="fixed flex flex-col  transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form action="#!">
                <div class="mb-3">
                    ...
                    <input type="text" id="documentsName" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Name" required="">
                </div>
                <div class="mb-3">
                    <label for="documentsType" class="inline-block mb-2 text-base font-medium">Type</label>
                    <select class="form-input border-slate-300 focus:outline-none focus:border-custom-500" data-choices="" name="documentsType" id="documentsType">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-center border rounded-md cursor-pointer dropzone border-slate-200 dark:border-zink-500">
                        <div class="fallback">
                        ...
                        <div class="w-full py-5 text-lg text-center dz-message needsclick">
                            ...
                            <h5 class="mb-0 font-normal text-slate-500 dark:text-zink-200 text-15">Drag and drop your files or <a href="#!">browse</a> your files</h5>
                        </div>
                    </div>
