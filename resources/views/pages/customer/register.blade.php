        ...
        <div
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                    <div class="grow">
                        <h5 class="text-16">Driver Onboarding</h5>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
                        ...
                        <div class="card">
                            <div class="card-body flex flex-col gap-5">
                                ...
                                <div>
                                    <label for="inputWithIcon" class="inline-block mb-2 text-base font-medium">License
                                        Number</label>
                                    <div class="relative">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <i data-lucide="mail"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                        <input type="date" id="inputWithIcon"
                                            class="ltr:pl-10 rtl:pr-10 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                ...
                                <div>
                                    <label for="inputWithIcon"
                                        class="inline-block mb-2 text-base font-medium">vehicle_id</label>
                                    <div class="relative">
                                        <i data-lucide="mail"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                ...
                                <div>
                                    <label for="medical_status" class="inline-block mb-2 text-base font-medium">Medical
                                        Status</label>
                                    <div class="relative">
                                        <i data-lucide="mail"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                        <select id="medical_status" name="medical_status"
                                            class="ltr:pl-10 rtl:pr-10 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                            <option value="" disabled selected>Select Medical Status</option>
                        ...
                        <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="mb-4 text-15">Licence ID Card (Front)</h6>
                                    <div>
                                        <input type="file" name="license_front"
                                            class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500"
                                            onchange="previewImage(event, 'kebeleIdFrontPreview')">
                                        <img id="kebeleIdFrontPreview" src="" alt="license_back ID Front Preview"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="mb-4 text-15">Licence ID Card (Back)</h6>
                                    <div>
                                        <input type="file" name="license_back"
                                            class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500"
                                            onchange="previewImage(event, 'kebeleIdBackPreview')">
                                        <img id="kebeleIdBackPreview" src="" alt="license_back ID Back Preview"
                                            style="display:none; margin-top: 10px; max-width: 100%; height: auto;">
                                    </div>
                                </div>
                            </div><!--end card-->
