        ...
        <div
            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                    <div class="grow">
                        <h5 class="text-16">Edit Drivers Information</h5>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
                        ...
                        <div class="card">
                            <div class="card-body flex flex-col gap-5">
                                <div>
                                    <label for="inputWithIcon" class="inline-block mb-2 text-base font-medium">First
                                        Name</label>
                                    <div class="relative">
                                        <i data-lucide="user"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                        <input type="text" id="inputWithIcon"
                                ...
                                <div>
                                    <label for="inputWithIcon" class="inline-block mb-2 text-base font-medium">Middle
                                        Name</label>
                                    <div class="relative">
                                        <i data-lucide="user"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                ...
                                <div>
                                    <label for="inputWithIcon" class="inline-block mb-2 text-base font-medium">Last
                                        Name</label>
                                    <div class="relative">
                                        <i data-lucide="user"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                ...
                                <div>
                                    <label for="inputWithIcon" class="inline-block mb-2 text-base font-medium">Phone
                                        Number</label>
                                    <div class="relative">
                                        <i data-lucide="phone"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                ...
                                <div>
                                    <label for="inputWithIcon" class="inline-block mb-2 text-base font-medium">Email</label>
                                    <div class="relative">
                                        <i data-lucide="mail"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                        <input type="text" id="inputWithIcon"
                                ...
                                <div>
                                    <label for="inputWithIcon"
                                        class="inline-block mb-2 text-base font-medium">license_number</label>
                                    <div class="relative">
                                        ...
                                        <input type="text" id="inputWithIcon"
                                            class="ltr:pl-10 rtl:pr-10 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                            name="license_number" placeholder="license_number"
                                            value="{{ old('license_number', $customer->license_number) }}">
                                    </div>
                                </div>
                                <div>
                                    <label for="inputWithIcon"
                                        class="inline-block mb-2 text-base font-medium">license_expiry_date</label>
                                    <div class="relative">
                                        ...
                                        <input type="text" id="inputWithIcon"
                                            class="ltr:pl-10 rtl:pr-10 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                            name="license_expiry_date" placeholder="license_expiry_date"
                                            value="{{ old('license_expiry_date', $customer->license_expiry_date) }}">
                                    </div>
                                </div>

                                <div>
                                    <label for="vehicle_id"
                                        class="inline-block mb-2 text-base font-medium">Vehicle</label>
                                    <div class="relative">
                                        <i data-lucide="pin"
                                            class="absolute size-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                                        <select id="vehicle_id" name="vehicle_id"
                                            ...
                                            @foreach ($vehicles as $vehicle)
                                                <option value="{{ $vehicle->id }}"
                                                    {{ $vehicle->id == $customer->vehicle_id ? 'selected' : '' }}>
                                ...
                                <div>
                                    <label for="inputWithIcon"
                                        class="inline-block mb-2 text-base font-medium">medical_status</label>
                                    <div class="relative">
                                        ...
                                        <input type="text" id="inputWithIcon"
                                            class="ltr:pl-10 rtl:pr-10 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                            name="medical_status" placeholder="medical_status"
                                            value="{{ old('medical_status', $customer->medical_status) }}">
                                    </div>
                                </div>
                        ...
                        <div>
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="mb-4 text-15">Photo (4x4)</h6>
                                    <div>
                                        ...
                                        <div class=" flex items-center">
                                            <img id="photoPreview" src="" alt="Photo Preview"
                                                style="display:none; margin-top: 10px; max-width: 200px; max-height: 200px; object-fit: cover;">
                                            @if ($customer->photo)
                                                <div class=" flex flex-col">
                                                    <span class=" text-slate-500">Current</span>
                                                    <img src="{{ asset($customer->photo) }}" alt="Current Photo"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="mb-4 text-15">license ID Card (Front)</h6>
                                    <div>
                                        <input type="file" name="license_front"
                                            class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500"
                                            onchange="previewImage(event, 'kebeleIdFrontPreview')">
                                        <div class=" flex flex-col">
                                            <img id="kebeleIdFrontPreview" src="" alt="Kebele ID Front Preview"
                                                style="display:none; margin-top: 10px; max-width: 100%; height: auto;">
                                            @if ($customer->license_front)
                                                <div class=" flex flex-col">
                                                    <span class=" text-slate-500">current</span>
                                                    <img src="{{ asset($customer->license_front) }}"
                                                        alt="Kebele ID Front" style="max-width: 100%; margin-top: 10px;">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="mb-4 text-15">license ID Card (Back)</h6>
                                    <div>
                                        <input type="file" name="license_back"
                                            class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500"
                                            onchange="previewImage(event, 'kebeleIdBackPreview')">
                                        <div class=" flex flex-col">
                                            <img id="kebeleIdBackPreview" src="" alt="Kebele ID Back Preview"
                                                style="display:none; margin-top: 10px; max-width: 100%; height: auto;">
                                            @if ($customer->license_back)
                                                <div class=" flex flex-col">
                                                    <span>current</span>
                                                    <img src="{{ asset($customer->license_back) }}" alt="Kebele ID Back"
