            ...
            <div
                ...
                <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                    ...
                    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                        <div class="grow">
                            <h5 class="text-16">User List View</h5>
                        </div>
                                        ...
                                        <div class="shrink-0">
                                            <button data-modal-target="addUserModal" type="button"
                                                class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                                                    ...
                                                    class="align-middle">Add User</span></button>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div>
                                                        <button type="button"
                                                            class="bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600 dark:bg-zink-700 dark:ring-custom-400/20 dark:hover:bg-custom-800/20 dark:focus:bg-custom-800/20 dark:active:bg-custom-800/20"><i
                                                                data-lucide="download" class="inline-block size-4"></i>
                                        ...
                                        <table
                                            ...
                                            <thead class="text-left">
                                                <tr
                                                    ...
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="name">FirstName</th>
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="name">MidleName</th>
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="name">LastName</th>
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                            ...
                                            <tbody class="list">
                                                @foreach ($users as $user)
                                                    <tr
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                            <a href="#!"
                                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id">{{ $user->id }}</a>
                                                        </td>
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                            <div class="flex items-center gap-2">
                                                                <div
                                                                    ...
                                                                    @if ($user->photo)
                                                                        <img src="{{ asset($user->photo) }}"
                                                                            alt="User Photo" class="h-10 w-10 rounded-full">
                                                                    @else
                                                                ...
                                                                <div class="grow">
                                                                    <h6 class="mb-1"><a href="#!"
                                                                            class="name">{{ $user->first_name }}</a></h6>
                                                                    <p class="text-slate-500 dark:text-zink-200">Bank
                                                                        Casher</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 flex space-x-2">
                                                            ...
                                                            <a data-modal-target="editUserModal{{ $user->id }}"
                                                            ...
                                                            <a data-modal-target="deleteModal{{ $user->id }}"
                                                    ...
                                                    <!-- Edit User Modal -->
                                                    <div id="editUserModal{{ $user->id }}" modal-center=""
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{ route('users.update', $user->id) }}" class="mt-10" method="POST"
                                                                    ...
                                                                    <div class="mb-3">
                                                                      ...
                                                                      <div class="mb-3">
                                                                        ...
                                                                        <!-- Current Photo -->
                                                                        @if ($user->photo)
                                                                            <img src="{{ asset($user->photo) }}" alt="Current Photo" id="current-photo" class="mb-2 rounded h-12">
                                                                        @endif
                                                                        ...
                                                                        <div id="photo-preview" class="mt-3">
                                                                            <img id="preview" src="#" alt="New Photo Preview" class="hidden h-12 rounded">
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    {{-- delete user --}}
                                                    <div id="deleteModal{{ $user->id }}" modal-center=""
                                                        class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    ...
                                                                    <div class="flex justify-center gap-2 mt-6">
                                                                        <button type="button"
                                                                            data-modal-close="deleteModal{{ $user->id }}"
    ...
    <div id="addUserModal" modal-center=""
        ...
        <div class="w-screen md:w-[40rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="{{ route('users.store') }}" class="mt-10" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="photo-field" class="inline-block mb-2 text-base font-medium">Photo</label>
                        <input 
                            type="file" 
                            name="photo" 
                            id="photo-field" 
                        ...
                        >
                        <div id="photo-preview" class="mt-3">
                            <img id="preview" src="#" alt="Image Preview" class="hidden w-32 h-32 rounded-full border border-slate-200 dark:border-zink-500">
                        </div>
                    </div>
                    <div class="flex justify-end gap-2 mt-4">
