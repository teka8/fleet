...
@section('content')
            ...
            <div
                ...
                <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                    ...
                    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                        <div class="grow">
                            <h5 class="text-16">Role List View</h5>
                        </div>
                        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                            <li
                                class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                                <a href="#!" class="text-slate-400 dark:text-zink-200">Roles</a>
                            </li>
                            ...
                            <div class="card" id="usersTable">
                                <div class="card-body">
                                    <div class="flex items-center">
                                        <h6 class="text-15 grow">Role List</h6>
                                        <div class="shrink-0">
                                            <button data-modal-target="addRoleModal" type="button"
                                                class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                                                    data-lucide="plus" class="inline-block size-4"></i> <span
                                                    class="align-middle">Add Role</span></button>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table
                                            ...
                                            <thead class="text-left">
                                                <tr
                                                    ...
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="joining-date">Date</th>
                                            ...
                                            <tbody class="list">
                                                @foreach ($roles as $role)
                                                    <tr
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                            <a href="#!"
                                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id">{{ $role->id }}</a>
                                                        </td>
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 flex space-x-2">
                                                            ...
                                                            <a data-modal-target="editRoleModal{{ $role->id }}"
                                                            ...
                                                            <a data-modal-target="deleteModal{{ $role->id }}"
                                                    ...
                                                    <div id="editRoleModal{{ $role->id }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <h5 class="text-16">Edit Role</h5>
                                                                <button data-modal-close="editRoleModal"
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{ route('roles.update', $role->id) }}"
                                                                    ...
                                                                    <div class="form-group mb-3">
                                                                        <label
                                                                            class="inline-block mb-2 text-base font-medium">Permissions:</label>
                                                                    ...
                                                                    <div class="flex justify-end gap-2 mt-4">
                                                                        <button type="reset"
                                                                            data-modal-close="editRoleModal"
                                                    ...
                                                    {{-- delete user --}}
                                                    <div id="deleteModal{{ $role->id }}" modal-center=""
                                                        class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    ...
                                                                    <div class="flex justify-center gap-2 mt-6">
                                                                        <button type="button"
                                                                            data-modal-close="deleteModal{{ $role->id }}"
                                        ...
                                        <div class="noresult" style="display: none">
                                            <div class="py-6 text-center">
                                                ...
                                                <p class="mb-0 text-slate-500 dark:text-zink-200">We've searched more than
                                                    199+ roles We did not find any roles for you search.</p>
                                            </div>
                                        </div>
                                    </div>
    ...
    {{-- add user --}}
    <div id="addRoleModal" modal-center=""
        class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
        <div class="w-screen md:w-[40rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-300/20">
                <h5 class="text-16">Add Role</h5>
                <button data-modal-close="addRoleModal"
                    class="transition-all duration-200 ease-linear text-slate-400 hover:text-red-500">
                    <i data-lucide="x" class="size-5"></i>
                </button>
            </div>
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <!-- HTML Form Start -->
                <form action="{{ route('roles.store') }}" method="POST" class="mt-10">
                    @csrf

                    <!-- Role Name Input -->
                    <div class="form-group mb-3">
                        <label for="name-field" class="inline-block mb-2 text-base font-medium">Role Name:</label>
                        <input type="text" name="name" id="name-field" placeholder="Enter Role Name"
                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                    </div>
                    ...
                    <!-- Form Buttons -->
                    <div class="flex justify-end gap-2 mt-4">
                        <button type="reset" data-modal-close="addRoleModal"
                            class="text-red-500 transition-all duration-200 ease-linear bg-white border-white btn hover:text-red-600 focus:text-red-600 active:text-red-600 dark:bg-zink-500 dark:border-zink-500">
                            Cancel
                        </button>
                        <button type="submit"
