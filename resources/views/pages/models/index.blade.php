                    ...
                    <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                        ...
                        <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                            <li
                                ...
                                <a href="#!" class="text-slate-400 dark:text-zink-200">Models</a>
                            </li>
                                        ...
                                        <div class="shrink-0">
                                            <a data-modal-target='addModal'
                                                class="text-white cursor-pointer btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                                                    ...
                                                    class="align-middle">Add new Model</span></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table
                                            ...
                                            <tbody class="list">
                                                @foreach ($models as $model)
                                                    <tr
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                            <a href="{{route('models.show',$model->id)}}"
                                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id">{{ $model->id }}</a>
                                                        </td>
                                                        {{-- <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 location">
                                                            <img src="{{asset( $model->logo )}}" class=" w-10 h-10 object-cover" alt="logo">
                                                        </td> --}}
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 location">
                                                            {{ $model->name }}</td>
                                                        </td> 
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 flex space-x-2">
                                                            ...
                                                            <a data-modal-target="editModal{{ $model->id }}"
                                                            ...
                                                            <a data-modal-target="deleteModal{{ $model->id }}"
                                                                class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 hover:bg-slate-100 hover:text-red-500 focus:bg-slate-100 focus:text-red-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                                href="#!">
                                                    ...
                                                    <!-- Edit  Modal -->
                                                    <div id="editModal{{ $model->id }}" modal-center=""
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <button
                                                                    data-modal-close="editModal{{ $model->id }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{ route('models.update', $model->id) }}" enctype="multipart/form-data"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="role"
                                                                            class="inline-block mb-2 text-base font-medium">Make</label>
                                                                        <select name="make_id" id="role" required
                                                                            class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500">
                                                                            @foreach ($makes as $make)
                                                                                <option value="{{ $make->id }}" @if ($model->make_id == $make->id) selected @endif>
                                                                                    {{ $make->name }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="flex justify-end gap-2 mt-4">
                                                                        <button type="reset" data-modal-close="editModal{{ $model->id }}"
                                                    ...
                                                    {{-- delete user --}}
                                                    <div id="deleteModal{{ $model->id }}" modal-center=""
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    ...
                                                                    <div class="flex justify-center gap-2 mt-6">
                                                                        <button type="button"
                                                                            data-modal-close="deleteModal{{ $model->id }}"
                                        ...
                                        <div class="noresult" style="display: none">
                                            <div class="py-6 text-center">
                                                ...
                                                <p class="mb-0 text-slate-500 dark:text-zink-200">We've searched more than
                                                    199+ models We did not find any models for you search.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-col items-center mt-8 md:flex-row">

                                        {{ $models->links('pagination::tailwind') }}
    ...
    <div id="addModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="{{ route('models.store') }}" class="mt-1" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
