    ...
    <div class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                <div class="relative col-span-12 overflow-hidden card 2xl:col-span-8 object-cover " style="background-image: url('assets/images/fleet.jpeg'); height:200px">
                    ...
                    <div class="relative card-body">
                        <div class="grid items-center grid-cols-12">
                            <div class="col-span-12 lg:col-span-8 2xl:col-span-7 ">
                                <h5 class="mb-3 font-normal tracking-wide text-slate-200">Welcome to Tewos FMS 🎉</h5>
                                {{-- <p class="mb-5 text-slate-400">A Core Banking Solution dashboard has just that purpose. It provides your banking team with a clear overview of key financial and website KPIs at any time.</p> --}}
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2">$<span class="counter-value" data-target="123126355252.18">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Total Deposit</p>
                    </div>
                </div><!--end col-->
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="8263461">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Total Customers</p>
                    </div>
                </div><!--end col-->
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="8134547">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Active Accounts</p>
                    </div>
                </div><!--end col-->
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="2634621436724">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Transaction volume</p>
                    </div>
                </div><!--end col-->
                <div class="col-span-12 card 2xl:col-span-4 2xl:row-span-2">
                    <div class="card-body">
                        <div class="flex items-center mb-3">
                            <h6 class="grow text-15">Statistics</h6>
                            <div class="relative">
                        ...
                        <div id="orderStatisticsChart" class="apex-charts" data-chart-colors='["bg-yellow-500", "bg-sky-500"]' dir="ltr"></div>
                    </div>
                </div><!--end col-->
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-3">
                            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        <p class="mb-1 text-slate-500 dark:text-zink-200">Total Accounts</p>
                                        <h5 class="text-15"><span class="counter-value" data-target="8263461">0</span></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        ...
                                        <h5 class="text-15">$<span class="counter-value" data-target="746.84">0</span>M</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
